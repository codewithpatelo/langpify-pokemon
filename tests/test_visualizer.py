...
def test_generate_battle_animation(
    mock_get_sprite, mock_create_frame, mock_mimsave, mock_pokemon_data
):
    ...
    assert (
        mock_create_frame.call_count >= 3
    )  # At least initial, final, and some battle frames
